...
for data in database:
    print(f"{database[data]["name"]:<30}{database[data]["exec_nbr"]:<10}{database[data]["exec_pts"]:<10}{database[data]["exm_pts"]:<10}{database[data]["tot_pts"]:<10}{database[data]["grade"]:<10}")
