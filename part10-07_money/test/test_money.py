...
"""
    ...
    def test_1_class_money_olemassa(self):
        try:
            ...
            self.fail(
                f"Calling construtor Money(1,1) threw an error \n{e}\n"
    ...
    def test_2_str(self):
        ...
        for test_case in test_cases:
            ...
            self.assertEqual(
                val,
                corr,
                f"Method __str__ should return "
    ...
    def test_9_encapsulation(self):
        ...
        for att in attr:
            if not att.startswith("_"):
                self.fail(
                    "Class should not have public attributes. "
        ...
        self.assertTrue(
            str(r) != test,
            f"Expression money.euros = 1000 should "
